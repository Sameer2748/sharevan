...
export default function OrdersPage() {
  ...
  const getEtaText = (order: any) => {
    if (order.etaText) return order.etaText;
    if (order.estimatedArrival) return order.estimatedArrival;
    return 'Reaching Soon';
  };
        ...
        {filteredOrders.length === 0 ? (
          <div className="bg-white rounded-3xl p-10 text-center shadow-sm">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Start tracking your deliveries once you place an order.
            </p>
            <button
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <span>{getStatusTime(order) || getEtaText(order)}</span>
                  </div>
                </button>
              );
            })}
